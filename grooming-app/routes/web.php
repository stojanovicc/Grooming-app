...
Route::middleware('auth')->group(function () {
    ...
    //Rute za BRISANJE NALOGA:
    Route::get('/delete-account', [AuthController::class, 'showDeleteForm'])->name('delete.account');
    Route::post('/delete-account', [AuthController::class, 'deleteAccount'])->name('delete.account.confirm');
