        ...
        <div class="row align-items-center">
            <div class="col-md-4 text-center">
                ...
                @auth
                    ...
                    <div>
                        <a href="{{ route('delete.account') }}" class="btn mt-3" style="border: 2px solid rgb(170, 9, 9); background-color: rgb(170, 9, 9); color: white;">
                            <i class="fa-solid fa-trash me-2" style="color: white;"></i>Obrisi nalog
                        </a>
                    </div>
                    @endif
                @endauth
