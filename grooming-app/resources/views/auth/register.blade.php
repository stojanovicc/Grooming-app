@extends('layouts.app') <!-- Uključuje glavni layout -->

@section('title', 'Registracija Vlasnika Salona') <!-- Dodaje naslov stranici -->

@section('content') <!-- Sadržaj specifičan za ovu stranicu -->
<style>
    body {
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('register') }}" method="POST">
                        @csrf
                        <!-- Polje za ime i prezime vlasnika -->
